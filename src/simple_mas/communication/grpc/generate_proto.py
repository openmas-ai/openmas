...
def fix_imports(output_dir: str) -> None:
    ...
    pb2_grpc_file = os.path.join(output_dir, "simple_mas_pb2_grpc.py")
    ...
    if os.path.exists(pb2_grpc_file):
        ...
        # Replace 'import simple_mas_pb2' with relative import
        content = content.replace(
            "import simple_mas_pb2 as simple__mas__pb2", "from . import simple_mas_pb2 as simple__mas__pb2"
        )

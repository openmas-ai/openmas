"""Deployment metadata parser for SimpleMas components."""
...
class DeploymentMetadata(BaseModel):
    """Deployment metadata for SimpleMas components."""

    version: str = Field(..., description="SimpleMas deployment metadata version")

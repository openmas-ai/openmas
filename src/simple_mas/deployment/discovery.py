"""Component discovery for SimpleMas deployment tools."""
...
class ComponentDiscovery:
    """Discover SimpleMas components in a directory structure."""

    def discover_components(
        self, directory: Union[str, Path], pattern: str = "**/simplemas.deploy.yaml"

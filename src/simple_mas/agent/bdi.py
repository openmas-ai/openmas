"""BDI agent implementation for SimpleMAS.

This module provides a base class for implementing BDI (Belief-Desire-Intention) agents
in SimpleMAS. It extends the BaseAgent class with hooks for beliefs, desires, and
...
class BdiAgent(BaseAgent):
    """Base agent class for BDI agents in SimpleMAS.

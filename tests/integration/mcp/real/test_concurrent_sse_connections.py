...
async def connect_and_call_echo(
    server_url: str, client_id: int, message: str
                        ...
                        if isinstance(result.content[0], TextContent):
                            ...
                            try:
                                ...
                                if response_data.get("echoed") == expected_message:
                                    ...
                                    client_logger.error(f"Response data mismatch. Expected '{expected_message}', got '{response_data.get('echoed')}'")
